...
const serveStaticFragment = require('./fragments/static/fragment');
const serveVanillaFragment = require('./fragments/vanilla/fragment');
const serveReactFragment = require('./fragments/react/fragment');
...
const server = http.createServer((req, res) => {
	...
	if (/.+\.js$/g.test(req.url)) {
		fileToStream(path.join(__dirname, req.url), 'application/javascript', res);
		return;
	}
